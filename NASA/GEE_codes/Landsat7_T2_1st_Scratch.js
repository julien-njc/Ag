...
function extract_satellite_IC(a_feature, start_date, end_date){
    ...
    var imageC = ee.ImageCollection('LANDSAT/LE07/C01/T2_SR')
    ...
    imageC = imageC.map(cloudMaskL457);
...
var outfile_name = 'Grant_4Fields_Landsat7_T2_' + wstart_date + "_" + wend_date;
