...
if random_or_all == "random":
    f_name = "NoJump_int_Grant_Irr_2008_2018_" + indeks + "_" + str(randCount) + "randomfields_JFD.csv"
    out_name = output_dir + "regular_int_Grant_Irr_2008_2018_" + indeks + "_" + str(randCount) + "randomfields_JFD.csv"
else:
    f_name = "NoJump_int_Grant_Irr_2008_2018_" + indeks + "_JFD.csv"
    out_name = output_dir + "regular_int_Grant_Irr_2008_2018_" + indeks + "_JFD.csv"
