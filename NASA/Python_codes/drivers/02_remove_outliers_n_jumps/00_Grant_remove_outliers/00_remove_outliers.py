...
if random_or_all == "random":
    out_name = output_dir + "00_noOutlier_int_Grant_Irr_2008_2018_" + indeks + "_" + str(randCount) + "randomfields.csv"
else:
    out_name = output_dir + "00_noOutlier_int_Grant_Irr_2008_2018_" + indeks + ".csv"
