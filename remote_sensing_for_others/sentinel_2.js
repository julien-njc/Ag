...
//
//  SF_table below is the variable name of the shapefile added to the assets.
// 
var SF = ee.FeatureCollection(SF_table);
print("Number of fiels in 2017 shapefile is ", SF_table.size());
...
var WA1 = ee.Geometry.Polygon([[xmin, ymin], [xmin, ymax], [xmed, ymax], [xmed, ymin], [xmin, ymin]]);
...
var outfile_name = 'Eastern_WA_2017_' + cloud_perc + "cloud_selectors_mean";
