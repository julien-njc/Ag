...
\usepackage[ruled,vlined,resetcount,algosection]{algorithm2e}
% \SetAlFnt{\small}
...
There are different products that fall under 
...
\footnote{This page says ``Caution: This dataset has been superseded by LANDSAT/LC08/C02/T1\_L2.'' So, it seems USGS Landsat 8 Level 2, Collection 2, Tier 1 should be superior
to Tier 1 SR, but in my plots it was not!}
...
Base on the information below and references therein, Collection 2 is an improvement
over Collection 1 (is there any time period for which Collection 2 does not exist but 1 does?).
Moreover, Collection 1 has only level-1 data, however, Collection 2 has level-1 data
as well as level-2.


\begin{description}
\item [Collection 1] Landsat Collection 1 was established in 2016 to improve archive management. It is being \textbf{\emph{superseded}} by Collection 2 as processing continues. \href{https://www.usgs.gov/core-science-systems/nli/landsat/landsat-collection-1?qt-science_support_page_related_con=1#qt-science_support_page_related_con}{Learn more about Collection 1 from the USGS.}
...
given by Alg.~\ref{alg:FindCentroidsAPoly}.
...
\hline
\rowcolor{aliceblue} 
Sentinel-2B & B8:~~~~~~0.78 -- 0.88 $\mu m$ & B4:~~~~~~0.65 -- 0.68 $\mu m$ & B2:~~~~~~0.046 -- 0.52 $\mu m$ \\ 
\hline
