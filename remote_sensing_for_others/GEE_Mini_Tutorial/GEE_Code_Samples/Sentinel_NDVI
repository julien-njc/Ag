...
print("Number of fiels in the shapefile is ", SF.size());
...
var wstart_date = '2017-08-01';
var wend_date = '2018-12-31';
var cloud_perc = 70;
...
var outfile_name = 'Eastern_WA_2018_' + cloud_perc + "cloud_selectors_mean";
