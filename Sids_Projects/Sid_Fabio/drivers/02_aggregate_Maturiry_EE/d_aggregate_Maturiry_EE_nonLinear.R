...
######################################################################
dir_base <- "/data/hydro/users/Hossein/Sids_Projects/SidFabio/01_days2maturity_EE_nonLinear/"
...
curr_in <- paste0(dir_base, veg_type, "_", param_type, "/")
...
current_out = paste0(out_dir_base, "/02_aggregate_Maturiry_EE_nonLinear/", veg_type, "_", param_type, "/") # "_", model_type, 
