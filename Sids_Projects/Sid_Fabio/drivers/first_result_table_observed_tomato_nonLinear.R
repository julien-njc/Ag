...
##  overleaf file. 
##  
##  Observed tomatoes are at hand now. We start 
##  with nonlinear model and Fabio's parameters. 
## 
##
rm(list=ls())
library(data.table)
...
out_dir = paste0(data_dir_base, "03_table_results/", veg_type, "_", param_type, "/")
...
################
#
#  Use Claudio's parameters
# 
param_type = "claudio" # "fabio" or "claudio"
