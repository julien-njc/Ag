...
######################################################################
dir_base <- "/data/hydro/users/Hossein/Sids_Projects/SidFabio/00_cumGDD_nonLinear/"
...
print ("line 39")
print (head(veg_params, 2))

print ("______________")
print ("Line 43")
print (paste0("veg_type: ", veg_type, " model_type: ", model_type, ", start_doy :", start_doy))
...
data_dir <- paste0(dir_base, veg_type, "/", gsub("-", "", model_type), "_", param_type, "/")
...
current_out = paste0(out_dir_base, "/01_days2maturity_EE_nonLinear/", veg_type, "_", param_type, "/") # "_", model_type, 
