...
needed_columns = ["ID", "Acres", "ExctAcr", "county", "CropTyp", "DataSrc", 
...
for seos in sos_list:
    ...
    filename = output_dir + "extended_2cropped_fields_noFilter_SEOS" + str(seos) + ".csv"
    ...
    filename = output_dir + "double_cropped_fields_noFilter_SEOS" + str(seos) + ".csv"
    output_dataframe.to_csv(filename, index = False)    
