...
\def\code#1{\text{\texttt{#1}}}
\def\codeRed#1{{\color{Maroon}{\text{\texttt{#1}}}}}
\def\codeGreen#1{{\color{Green}{\text{\texttt{#1}}}}}
\def\codeCyan#1{{\color{cyan}{\text{\texttt{#1}}}}}
\def\codeGoldenrod#1{{\color{RedOrange}{\textbf{\texttt{#1}}}}}
...
\newpage
\input{./coding_chapter}
\input{./organizing}
\input{./GEE_Chapter_tufte}
