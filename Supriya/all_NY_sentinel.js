...
var NY = ee.Geometry.Polygon([[xmin, ymin], 
                              [xmin, ymax], 
                              [xmax, ymax], 
                              [xmax, ymin], 
                              [xmin, ymin]]);
...
Map.addLayer(NY, {color: 'red'}, 'geodesic polygon');
...
var outfile_name = 'all_NY_sentinel_1km_' + cloud_perc + 'cloud';
