...
Map.addLayer(SF, {color: 'black'}, 'geodesic polygon');
Map.addLayer(box1, {color: 'red'}, 'geodesic polygon');
Map.addLayer(box2, {color: 'green'}, 'geodesic polygon');
Map.addLayer(box3, {color: 'blue'}, 'geodesic polygon');
Map.addLayer(box4, {color: 'white'}, 'geodesic polygon');
...
var outfile_name = 'all_WA_sentinel_1km_' + cloud_perc + 'cloud';
Export.table.toDrive({
  ...
  fileFormat: 'CSV',
  selectors:["grid_id", "doy", "EVI", "system_start_time", "image_year"]
});
