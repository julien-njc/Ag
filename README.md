...
The repository `remote_sensing_for_others` includes sample code for other members of Kirti's group.
...
3. The state of Washington in `sentinel_2.js` is divided into two big regions. Adapt according to your needs.
