    ...
    for (last_survey_date in last_survey_date_options){
      for (double_potential in double_potential_options){
        for (irrigated in irrigated_options){
          ...
          output_name <- paste("Yr", name_part_2, name_part_3, name_part_4, 
                               name_part_5, name_part_6, # name_part_7, 
                               sep = "_")

          assign(x = output_name, value = {filtered_SF})
...
onlyAnnuals_JustIrr_LastSrvFalse_NASSIn_2016_2017_2018 = rbind(Yr_2016_onlyAnnuals_JustIrr_LastSrvFalse_NASSIn, 
                                                               Yr_2017_onlyAnnuals_JustIrr_LastSrvFalse_NASSIn, 
                                                               Yr_2018_onlyAnnuals_JustIrr_LastSrvFalse_NASSIn)



onlyAnnuals_JustIrr_LastSrvCorrect_NASSIn_2016_2017_2018 = rbind(Yr_2016_onlyAnnuals_JustIrr_LastSrvCorrect_NASSIn, 
                                                                 Yr_2017_onlyAnnuals_JustIrr_LastSrvCorrect_NASSIn, 
                                                                 Yr_2018_onlyAnnuals_JustIrr_LastSrvCorrect_NASSIn)

writeOGR(obj = onlyAnnuals_JustIrr_LastSrvFalse_NASSIn_2016_2017_2018, 
         dsn = paste0(write_dir, "/", "onlyAnnuals_JustIrr_LastSrvFalse_NASSIn_2016_2017_2018_sentinel", "/"), 
         layer = "onlyAnnuals_JustIrr_LastSrvFalse_NASSIn_2016_2017_2018_sentinel", 
         driver = "ESRI Shapefile")


writeOGR(obj = onlyAnnuals_JustIrr_LastSrvCorrect_NASSIn_2016_2017_2018, 
         dsn = paste0(write_dir, "/", "onlyAnnuals_JustIrr_LastSrvCorrect_NASSIn_2016_2017_2018_sentinel", "/"), 
         layer = "onlyAnnuals_JustIrr_LastSrvCorrect_NASSIn_2016_2017_2018_sentinel", 
         driver = "ESRI Shapefile")
