...
#SBATCH --partition=stockle,rajagopalan,cahnrs,cahnrs_gpu,kamiak
#SBATCH --requeue
...
Rscript --vanilla /home/vladyslav.oles/hardiness/stats_by_grid_kamiak.R "$(( SLURM_ARRAY_TASK_ID * n ))" "$(( SLURM_ARRAY_TASK_ID * n + n - 1 ))"
