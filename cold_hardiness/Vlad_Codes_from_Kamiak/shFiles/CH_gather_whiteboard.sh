...
#SBATCH --time=5-00:10:00    # Wall clock time limit in Days-HH:MM:SS
...
Rscript --vanilla /home/vladyslav.oles/hardiness/gather_whiteboard_kamiak.R "$(( SLURM_ARRAY_TASK_ID ))"
