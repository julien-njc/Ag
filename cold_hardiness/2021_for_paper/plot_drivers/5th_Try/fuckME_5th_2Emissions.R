...
output_dir <- "/Users/hn/Documents/01_research_data/cold_hardiness/hossein_locations/Markus_Figrue_3/5th_try/both_emissionsOnStrip/"
...
for (a_fucking_loc in unique(CH_dt$location)){
  CH_dt_F1 <- CH_dt %>% filter(time_period %in% c("2025-2049") & location==a_fucking_loc)
  CH_dt_F2 <- CH_dt %>% filter(time_period %in% c("2050-2074") & location==a_fucking_loc)
  CH_dt_F3 <- CH_dt %>% filter(time_period %in% c("2075-2099") & location==a_fucking_loc)
  CH_dt_obs<- CH_dt %>% filter(time_period %in% c("1980-2003") & location==a_fucking_loc)
  ...
  CH_dt_F1_med <- CH_dt_median %>% filter(time_period %in% c("2025-2049") & location==a_fucking_loc)
  CH_dt_F2_med <- CH_dt_median %>% filter(time_period %in% c("2050-2074") & location==a_fucking_loc)
  CH_dt_F3_med <- CH_dt_median %>% filter(time_period %in% c("2075-2099") & location==a_fucking_loc)
  CH_dt_obs_med<- CH_dt_median %>% filter(time_period %in% c("1980-2003") & location==a_fucking_loc)
  ...
  out_name_1 = paste0(a_fucking_loc, "_", "2025-2049", ".pdf")
  out_name_2 = paste0(a_fucking_loc, "_", "2050-2074", ".pdf")
  out_name_3 = paste0(a_fucking_loc, "_", "2075-2099", ".pdf")
