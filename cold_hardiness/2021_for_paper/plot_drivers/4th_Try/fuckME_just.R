...
CH_dt_F1 <- CH_dt %>% filter(time_period %in% c("2025-2049"))
CH_dt_F2 <- CH_dt %>% filter(time_period %in% c("2050-2074"))
CH_dt_F3 <- CH_dt %>% filter(time_period %in% c("2075-2099"))

CH_dt_obs <- CH_dt %>% filter(time_period %in% c("1980-2003"))
...
fig_H <- 10
ggsave(plot = a_plt,
       filename=paste0("4th_Try_CH_F1.pdf"),
...
ggsave(plot = a_plt,
       filename = paste0("4th_Try_CH_F2.pdf"),
       width=fig_W, height=fig_H, units = "in", 
       dpi = 400, device = "pdf",
       limitsize = FALSE,
       path = output_dir)
...
ggsave(plot = a_plt,
       filename = paste0("4th_Try_CH_F3.pdf"),
       width=fig_W, height=fig_H, units = "in", 
       dpi = 400, device = "pdf",
       limitsize = FALSE,
       path = output_dir)
...
fig_H <- 10
ggsave(plot = a_plt,
       filename=paste0("4th_Try_tmin_F1.pdf"),
       width=fig_W, height=fig_H, units = "in", 
       dpi=400, device = "pdf",
       limitsize = FALSE,
       path = output_dir)
...
ggsave(plot = a_plt,
       filename = paste0("4th_Try_tmin_F2.pdf"),
       width=fig_W, height=fig_H, units = "in", 
       dpi = 400, device = "pdf",
       limitsize = FALSE,
       path = output_dir)
...
ggsave(plot = a_plt,
       filename = paste0("4th_Try_tmin_F3.pdf"),
       width=fig_W, height=fig_H, units = "in", 
       dpi = 400, device = "pdf",
       limitsize = FALSE,
       path = output_dir)
