...
sept_summary_comp <- sept_summary_comp %>% 
                     filter(!(time_period %in% c("2006-2025", "1979-2015"))) %>% # 1950-2005
                     data.table()
...
sept_summary_comp$emission[sept_summary_comp$emission == "historical"] = "Historical"


time_periods = c("1950-2005", "2026-2050", "2051-2075", "2076-2099")
...
diffs <- projec_diff_from_hist(dt_dt = sept_summary_comp_yearsMedian_perModel, diff_from="1950-2005")
...
plot_base <- paste0("/Users/hn/Documents/00_GitHub/ag_papers/chill_paper", 
                    "/02_Springer_2/figure_201_ModHist/cp_diff_map/")
