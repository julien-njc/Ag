...
source(bloom_plot_core_source)
source(chill_core_source)
merged_plt <- double_cloud_2_rows_Accum_VertDD_CP_Springer(d1=merged_dt, y_interceptt=50)
...
ggsave(plot = merged_plt,
       filename = paste0("00_Acum_CPHeat_RCP45_lowVariety.png"), 
...
ggsave(plot = merged_plt,
       filename = paste0("00_Acum_CPHeat_RCP85_lowVariety.png"), 
       width = 13, height=10, units = "in", 
       dpi = 400, device = "png",
       path = plot_dir)
print (plot_dir)
