...
heat_slopes <-  readRDS(paste0(daily_vertDD_dir, "slopes_maxDD_CalendarBased_LV.rds"))
...
ggsave(plot = merged_plt,
       filename = paste0("00_Acum_CPHeat_RCP45_lowVariety_Slopes_CalendarBased.png"), 
...
ggsave(plot = merged_plt,
       filename = paste0("00_Acum_CPHeat_RCP85_lowVariety_Slopes_CalendarBased.png"), 
       width = 11, height=10, units = "in", 
       dpi = 400, device = "png",
       path = plot_dir)
print (plot_dir)
