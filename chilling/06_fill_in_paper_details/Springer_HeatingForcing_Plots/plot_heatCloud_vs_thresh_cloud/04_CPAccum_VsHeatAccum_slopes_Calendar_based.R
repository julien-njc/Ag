...
#
# This for-loop takes care of RCP 8.5. and next one RCP 4.5
...
plot_dir <- paste0(plot_base_dir, "/CPAccum_heatAccum/calendarBasedSlopes/")
...
ggsave(plot = merged_plt,
       filename = paste0("00_Acum_CPHeat_", gsub(" ", "_", app_tp), "_RCP85_Slopes_CalendarBased.png"), 
...
#
# This for-loop takes care of RCP 4.5, and previous one RCP 8.5.
#
...
ggsave(plot = merged_plt,
       filename = paste0("00_Acum_CPHeat_", gsub(" ", "_", app_tp), "_RCP45_Slopes_CalendarBased.png"), 
       width = 11, height=10, units = "in", 
       dpi = 400, device = "png",
       path = plot_dir)
print (plot_dir)
