...
tabPanel(tags$b("CDI"), value='CDI', 
         div(class="outer",
             ...
             absolutePanel(id = "controls", class = "panel panel-default",
                           ...
                           gsub('"grape_variety"', '"grape_variety_cdi"', includeHTML("grape_variety.html")),
...
tabPanel(tags$b("heat degree-days"), value='DDh', 
         div(class="outer",
             ...
             absolutePanel(id = "controls", class = "panel panel-default",
                           ...
                           gsub('"grape_variety"', '"grape_variety_ddh"', includeHTML("grape_variety.html")),
...
tabPanel(tags$b("no switch"), value='no switch', 
         div(class="outer",
             ...
             absolutePanel(id = "controls", class = "panel panel-default",
                           ...
                           gsub('"grape_variety"', '"grape_variety_no_switch"', includeHTML("grape_variety.html")),
...
tabPanel(tags$b("switch day"),value='switch day', 
         div(class="outer",
             ...
             absolutePanel(id = "controls", class = "panel panel-default",
                           ...
                           gsub('"grape_variety"', '"grape_variety_switch_day"', includeHTML("grape_variety.html")),
...
tabPanel(tags$b("de-/acclimation slopes"),value='slope', 
         div(class="outer",
             ...
             absolutePanel(id = "controls", class = "panel panel-default", 
                           ...
                           gsub('"grape_variety"', '"grape_variety_slope"', includeHTML("grape_variety.html")),
